 ...
 * 
 */
public class ConsumerTool2 extends Thread implements MessageListener, ExceptionListener {
    ...
    private String url = "tcp://localhost:61636";
    private boolean transacted;
    private boolean durable;
    private String clientId;
    private int ackMode = Session.AUTO_ACKNOWLEDGE;
    private String consumerName = "James2";
    ...
    public static void main(String[] args) throws Exception {
        ArrayList<ConsumerTool2> threads = new ArrayList();
        ConsumerTool2 consumerTool = new ConsumerTool2();
        ...
        for (int threadCount = 1; threadCount <= parallelThreads; threadCount++) {
            consumerTool = new ConsumerTool2();
        ...
        while (true) {
            Iterator<ConsumerTool2> itr = threads.iterator();
            int running = 0;
            while (itr.hasNext()) {
                ConsumerTool2 thread = itr.next();
                if (thread.isAlive()) {
                    running++;
                }
            }
    ...
    public void queueDeleter() throws Exception{
        ...
        String parameter="moo.bar";   // Queue name
        ObjectName activeMQ = new ObjectName("org.apache.activemq:brokerName=broker-3,type=Broker");
        if(parameter != null) {
